export default function Footer() {
  ...
  return (
    <footer className="relative z-50 bg-white">
        ...
        <div className="max-w-none">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[320px_320px_600px] gap-12 sm:gap-16 md:gap-20 lg:gap-24">
            ...
            <div className="space-y-0.5">
              <p className="text-base sm:text-lg md:text-xl lg:text-[22px] leading-[1.6] text-black font-normal">Suite 2</p>
              <p className="text-base sm:text-lg md:text-xl lg:text-[22px] leading-[1.6] text-black font-normal">9 Marsh Street</p>
              <p className="text-base sm:text-lg md:text-xl lg:text-[22px] leading-[1.6] text-black font-normal">Bristol, BS1 4AA</p>
              <p className="text-base sm:text-lg md:text-xl lg:text-[22px] leading-[1.6] text-black font-normal">United Kingdom</p>
            </div>
            ...
            <div className="space-y-8 sm:space-y-10 md:space-y-12 lg:space-y-16">
              {/* Social Links */}
              <div className="space-y-0.5">
                <a href="#" className="block text-base sm:text-lg md:text-xl lg:text-[22px] leading-[1.6] text-black hover:opacity-60 transition-opacity font-normal">
                  Twitter / X
                </a>
                <a href="#" className="block text-base sm:text-lg md:text-xl lg:text-[22px] leading-[1.6] text-black hover:opacity-60 transition-opacity font-normal">
                  Instagram
              ...
              {/* General Enquiries */}
              <div className="space-y-0.5">
                <p className="text-base sm:text-lg md:text-xl lg:text-[22px] leading-[1.6] text-black font-normal">General enquiries</p>
                <a href="mailto:hello@lusion.co" className="block text-base sm:text-lg md:text-xl lg:text-[22px] leading-[1.6] text-black hover:opacity-60 transition-opacity font-normal break-all">
                  hello@lusion.co
                </a>
              </div>
              ...
              {/* New Business */}
              <div className="space-y-0.5">
                <p className="text-base sm:text-lg md:text-xl lg:text-[22px] leading-[1.6] text-black font-normal">New business</p>
                <a href="mailto:business@lusion.co" className="block text-base sm:text-lg md:text-xl lg:text-[22px] leading-[1.6] text-black hover:opacity-60 transition-opacity font-normal break-all">
                  business@lusion.co
                </a>
              </div>
            </div>
          ...
          <div className="mt-12 sm:mt-16 md:mt-20 lg:mt-24 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 sm:gap-4 text-sm sm:text-base md:text-lg lg:text-[20px] text-black font-normal">
            ...
            <div className="flex items-center gap-3 sm:gap-4 order-2 sm:order-3">
              ...
              >
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="sm:w-7 sm:h-7 md:w-8 md:h-8 lg:w-10 lg:h-10 group-hover:stroke-black stroke-white transition-all">
      ...
      <div className="relative bg-black px-6 sm:px-8 md:px-12 lg:pl-16 lg:pr-20 pt-8 sm:pt-10 md:pt-12 pb-2 sm:pb-14 md:pb-16 min-h-[400px] sm:min-h-[500px] md:min-h-[600px] lg:min-h-[700px]">
        <div className="max-w-none">
          {/* Keep Scrolling text */}
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-8 sm:gap-4 mb-12 sm:mb-16 md:mb-20 lg:mb-12">
            ...
            <div className="flex items-center gap-2 sm:gap-3 lg:gap-4">
              <span className="text-[10px] sm:text-xs md:text-sm lg:text-[20px] uppercase tracking-[0.10em] font-normal text-white whitespace-nowrap">NEXT PAGE</span>
              <div className="w-20 sm:w-24 md:w-32 lg:w-40 h-[1px] lg:h-[1.5px] bg-[#545454]"></div>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="sm:w-6 sm:h-6 lg:w-[30px] lg:h-[30px] -ml-1 flex-shrink-0">
